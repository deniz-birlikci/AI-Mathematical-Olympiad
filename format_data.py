...
"""
Cleans and formats merged_math json data for SFTTrainer
"""

def format_math_json(data_path):
    """
...
def create_formatted_math_json(data_path):
    """
    ...
    with open(new_path, 'w') as f:
        json.dump(format_math_json(data_path), f, indent=4)
